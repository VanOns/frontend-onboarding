...
Om te kunnen beoordelen of jouw development skills goed aansluiten bij het Van Ons team hebben we een kleine assessment voorbereid. Het doel is om een typische "real world" situatie na te bootsen waarin je als het ware met een ticket uit de backlog van project X aan de slag gaat.
...
- De lijst van todo's is standaard gesorteerd op datum. De eerstvolgende todo staat bovenaan.
- De sortering kon omgekeerd worden met de knop rechtsboven in de lijst.
- Voltooide todo's staan in een aparte tab. Er kan dus gewisseld worden tussen de tab met openstaande todo's en de tab met voltooide todo's.
- Er kunnen nieuwe todo's toegevoegd worden.
- Bestaande todo's kunnen verijderd en bewerkt worden.
- Todo's kunnen afgevinkt worden. Dit kan zowel in de lijst met openstaande todo's als in de lijst met voltooide todo's.
- De datum van een todo wordt soms weergeven als 'Yesterday', 'Today' of 'Tomorrow'. In andere gevallen tonen we gewoon de datum.
- Boven de lijst worden de totalen weergeven als gesproken tekst. Dus geen 5 todo's, maar vijf todo's.

Een designer bij Van Ons heeft een design gemaakt en gedeeld in [Figma](https://www.figma.com/design/LrN9uJLUNxhiRoYYh4pJFd/Van-Ons---Onboarding-V2?m=dev&node-id=0-1).
